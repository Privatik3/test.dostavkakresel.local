	...
	public function editOption($option_id, $data) {
		...
		if (isset($data['option_value'])) {
			foreach ($data['option_value'] as $option_value) {
				...
				$this->db->query("DELETE FROM " . DB_PREFIX . "fc_option_value_to_category WHERE option_value_id = '" . (int)$option_value['option_value_id'] . "'");
				
				if ((int)$option_value['category_id']) {
					$this->db->query("INSERT INTO " . DB_PREFIX . "fc_option_value_to_category SET option_value_id = '" . (int)$option_value['option_value_id'] . "', category_id = '" . (int)$option_value['category_id'] . "'");
				}

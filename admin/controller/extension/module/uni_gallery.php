...
class ControllerExtensionModuleUniGallery extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('extension/module/uni_gallery', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/uni_gallery', 'token='.$this->session->data['token'].$url, 'SSL')
		);

		$data['insert'] = $this->url->link('extension/module/uni_gallery/insert', 'token='.$this->session->data['token'].$url, 'SSL');
		$data['delete'] = $this->url->link('extension/module/uni_gallery/delete', 'token='.$this->session->data['token'].$url, 'SSL');
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('extension/module/uni_gallery/update', 'token=' . $this->session->data['token'] . '&gallery_id=' . $result['gallery_id'] . $url, 'SSL')
			);
		...
		$data['sort_name'] = $this->url->link('extension/module/uni_gallery', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('extension/module/uni_gallery', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('extension/module/uni_gallery', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/module/uni_gallery_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['gallery_id'])) { 
			$data['action'] = $this->url->link('extension/module/uni_gallery/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('extension/module/uni_gallery/update', 'token=' . $this->session->data['token'] . '&gallery_id=' . $this->request->get['gallery_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('extension/module/uni_gallery', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/module/uni_gallery_form.tpl', $data));
	}

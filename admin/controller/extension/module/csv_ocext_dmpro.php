...
class ControllerExtensionModuleCSVOcextDMPRO extends Controller {
	...
	private $error = array();
        private $this_version = '5.7.0.0';
        private $this_extension = 'ocext_dmpro_csv_new';
		...
		$this->load->model('setting/setting');
                ...
                $data['odmpro_format_data']['csv,xls,xlsx'] = 'csv';
			...
			$this->session->data['success'] = $this->language->get('text_success');
                        ...
                        if(isset($this->request->post['odmpro_update_csv_link'])){
                            ...
                            $this->model_tool_csv_ocext_dmpro->editSetting('odmpro_update_csv_link', $this->request->post);
                        }
                ...
                if($this->config->get('odmpro_tamplate_data') && !$this->config->get('odmpro_last_version_data_migrate')){
                    ...
                    $this->model_tool_csv_ocext_dmpro->editSetting('odmpro',$odmpro_tamplate_data_migrate);
                    ...
                    if($this->config->get('odmpro_update_csv_link')){
                        ...
                        $this->model_tool_csv_ocext_dmpro->editSetting('odmpro_update_csv_link',$odmpro_update_csv_link_migrate);
                        
                    }
                    
                    $this->model_setting_setting->editSetting('odmpro_last_version_data_migrate', array('odmpro_last_version_data_migrate'=>1));

                }
                
                $config_odmpro_tamplate_data = $this->model_tool_csv_ocext_dmpro->getSetting('odmpro','odmpro_tamplate_data');
                
                $odmpro_update_csv_link = $this->model_tool_csv_ocext_dmpro->getSetting('odmpro_update_csv_link','odmpro_update_csv_link');
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
                    ...
                    'href'      => $this->url->link('extension/module', ''.$this->token_name.'=' . $this->session->data[$this->token_name], 'SSL'),
                    'separator' => ' :: '
   		);
   		$data['breadcrumbs'][] = array(
        ...
        public function getStepOneSettings() {
            ...
            if(!$config_odmpro_tamplate_data && !$this->config->get('odmpro_csv_first_us')){
                ...
                if ($this->validate()) {
                    ...
                    $this->model_tool_csv_ocext_dmpro->editSetting('odmpro', $import_sample_data);
                    $this->model_setting_setting->editSetting('odmpro_csv_first_us', array('odmpro_csv_first_us'=>1));
            ...
            $data['encodings'] = array('UTF-8','Windows 1251','Windows 1252');
            ...
            if(!isset($data['tamplate_data_selected']['log_file_name'])){
                
                $data['tamplate_data_selected']['log_file_name'] = 'csv/ocext_log_csv_import_export';
            ...
            $data['operators_group_id_box'] = array('&lt;'=>'&lt;','≤'=>'≤','='=>'=','≥'=>'≥','&gt;'=>'&gt;','≠'=>'≠','±'=>'±','like_left'=>'Содержит префикс слева','like_right'=>'Содержит префикс справа','like'=>'Содержит');
            
            $data['count_group_id_box'] = 3;
            ...
            //var_dump($data['tamplate_data_selected']);
        ...
        public function getStepTwoSettings() {
            ...
            if($format_data=='csv'){
                ...
                foreach ($odmpro_tamplate_data as $data_field => $data_value) {
                    ...
                    if( $type_process=='import' &&  $odmpro_tamplate_data['file_url'] && $data_field=='file_url' ){
                        
                        $httpcode = $this->model_tool_csv_ocext_dmpro->getFileByURL($odmpro_tamplate_data['file_url'],TRUE);
                    ...
                    if( $type_process=='import' &&  $odmpro_tamplate_data['file_upload'] && $data_field=='file_upload' ){
                ...
                if($this->anyxls && isset($odmpro_tamplate_data['anyxls_xls_upload']) && $odmpro_tamplate_data['anyxls_xls_upload']){
                ...
                if($this->anyxml && isset($odmpro_tamplate_data['anyxml_xml_upload']) && $odmpro_tamplate_data['anyxml_xml_upload']){
                ...
                if($type_process=='import' && $odmpro_tamplate_data['file_url']){
                    ...
                    $file = $this->model_tool_csv_ocext_dmpro->getFileByURL($odmpro_tamplate_data['file_url']);
                ...
                if(isset($odmpro_tamplate_data['group_id_box']['category_matching_csv_column_name']) && $odmpro_tamplate_data['group_id_box']['category_matching_csv_column_name']){
                    ...
                    if(isset($yandex_market_categories_for_csv['field_position']) && in_array($category_matching_csv_column_name,$yandex_market_categories_for_csv['field_position'])){
                        ...
                        if($num_pos_categories && isset($yandex_market_categories_for_csv['data'])){
                            ...
                            foreach($yandex_market_categories_for_csv['data'] as $yandex_market_categories_rows){
                                    ...
                                    $data['yandex_market_categories'][$yandex_market_categories_rows[$num_pos_categories]] = $yandex_market_categories_rows[$num_pos_categories];
                ...
                if($type_process=='import' && $csv_fields['count_rows'] && $file_for_view){
                    
                    if($odmpro_tamplate_data['file_url']){
                     
                        $data['csv_data_for_view'] = $this->model_tool_csv_ocext_dmpro->getCsvRows(FALSE,1,10,$odmpro_tamplate_data,$file_url_for_view,FALSE,100,'... ...',TRUE);
                        ...
                        $data['csv_data_for_view'] = $this->model_tool_csv_ocext_dmpro->getCsvRows(FALSE,1,10,$odmpro_tamplate_data,'',FALSE,100,'... ...',TRUE,FALSE,$file_url_for_view);
                ...
                foreach ($types_data as $field => $type_data) {
                    ...
                    if(isset($general_settings_fields[$type_data]) && $general_settings_fields[$type_data]['additinal_settings']){
                        ...
                        foreach ($general_settings_fields[$type_data]['additinal_settings'] as $additinal_column=>$additinal_column_param) {
                            ...
                            /*
                            * stock_class_id_by_quantity
                             */
                            elseif($additinal_settings[$type_data][$j]['element']=='select' && $additinal_column=='stock_status_id_by_quantity'){
                             ...
                             * image_upload_curl
                             */
                            elseif($additinal_settings[$type_data][$j]['element']=='select' && $additinal_column=='image_upload_curl'){
                             ...
                             * categories_filter
                             */
                            elseif($additinal_settings[$type_data][$j]['element']=='select' && $additinal_column=='categories_filter'){
                                ...
                                foreach ($options as $option) {
                                    ...
                                    if(isset($odmpro_tamplate_data['type_data_general_settings'][$type_data][$additinal_column]) && $odmpro_tamplate_data['type_data_general_settings'][$type_data][$additinal_column] == $option['category_id']){
                             ...
                             * seo_url_generator
                             */
                            elseif($additinal_settings[$type_data][$j]['element']=='select' && $additinal_column=='seo_url_generator'){
        ...
        public function setTemplateData() {
            ...
            if ($this->validate()) {
                ...
                $this->model_tool_csv_ocext_dmpro->editSetting('odmpro', $odmpro_tamplates_data);
        ...
        public function startImport() {
            ...
            if(isset($odmpro_tamplate_data['new_file_upload']) && $odmpro_tamplate_data['new_file_upload']){
            ...
            if(!$json['error']){
                 ...
                 */
                $import_result = $this->model_tool_csv_ocext_dmpro->getCsvRows($file,$start+1,$limit,$odmpro_tamplate_data);
                
                unset($file);
                
                $this->model_tool_csv_ocext_dmpro->importCSV($odmpro_tamplate_data,$type_data_columns_by_type_data,$import_result,$log_data);
                
            }
            
            $json['total'] = $import_result['count_rows'];
            
            if(($start+$limit)>$import_result['count_rows'] && $import_result['count_rows']>0){

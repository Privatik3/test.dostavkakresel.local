...
$_['entry_group_mode']          = 'Выберите режим отображения';
...
$_['tab_related_group']         = 'Связанные товары по категориям';
...
$_['related_modes']             = array(
									0 => 'Не объединять по вкладкам',
									1 => 'Объединять во вклдаки по категорим'
								);

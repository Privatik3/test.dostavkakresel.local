...
table tr td:nth-child(1) {width:300px;max-width:300px;text-align:right;}
table tr td + td {padding:7px 0 7px 10px}
1table tr:nth-child(2n) {background: #f4f4f4;}
</style>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-language">
          ...
          <?php foreach ($languages as $language) { ?>
            <div id="language<?php echo $language['language_id']; ?>" class="tab-pane">
              <table class="form">
                <tr>
                  <td><span class="required">*</span> <label><?php echo $entry_title; ?></label></td>
                  <td><input name="news_description[<?php echo $language['language_id']; ?>][title]" class="form-control" value="<?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['title'] : ''; ?>" />
                ...
                <tr>
                  <td><label><?php echo $entry_meta_description; ?></label></td>
                  <td><textarea name="news_description[<?php echo $language['language_id']; ?>][meta_description]" class="form-control"><?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['meta_description'] : ''; ?></textarea></td>
                </tr>
                <tr>
                  <td><span class="required">*</span> <label><?php echo $entry_description; ?></label></td>
        ...
        <div id="tab-setting">
          <table class="form">
            <tr>
              <td><label><?php echo $entry_store; ?></label></td>
              <td>
			...
			<tr>
              <td><label><?php echo $entry_date_added; ?></label></td>
              <td><input type="text" name="date_added" value="<?php echo $date_added; ?>" class="form-control date" data-date-format="YYYY-MM-DD" /></td>
            </tr>
            <tr>
              <td><label><?php echo $entry_keyword; ?></label></td>
              <td><input type="text" name="keyword" value="<?php echo $keyword; ?>" class="form-control" /></td>
            </tr>
            <tr>
            <td><label><?php echo $entry_image; ?></label></td>
            <td>

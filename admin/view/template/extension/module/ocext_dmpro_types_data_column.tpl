<?php if($type_data_and_column_additional){ ?>
    ...
    <h5 style="color: #ea1010; margin-bottom: 10px;"><?php echo $entry_type_data_column_title ?> <span data-toggle="tooltip" title="" data-original-title='<?php echo $entry_type_data_column_title_help; ?>' ></span></h5>
    ...
    <?php foreach($type_data_and_column_additional as $j_additional => $additional){ ?>
        ...
        <?php } ?>
                ...
                <?php }elseif(isset($additional['element']) && $additional['element']=='input' && !isset($additional['group']) && !isset($additional['range'])){ ?>
                    ...
                    <input style='margin-top:5px;width:90% !important; display: inline-block' type="<?php echo $additional['type'] ?>" name="<?php echo $additional['name'] ?>" value="<?php echo $additional['value'] ?>" placeholder="<?php echo $additional['placeholder'] ?>" class='form-control'  />
                    ...
                    <?php if(isset($additional["help"]) && $additional["help"]){ ?>
                        <div data-toggle="help-box" title="" data-original-title='<?php echo $additional["help"]; ?>' ></div>
                    <?php } ?>

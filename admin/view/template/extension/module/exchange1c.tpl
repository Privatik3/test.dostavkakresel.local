				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="tab-general">
						...
						<fieldset>
							...
							<div class="form-group">
								<?php echo $html_upload_files_unlink; ?>
							</div>
						</fieldset>
						<fieldset>
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="tab-product-features">
									<fieldset>
										...
										<div class="form-group">
											<?php echo $html_product_option_name ?>
										</div>
										<div class="form-group">
					...
					<div class="tab-pane" id="tab-updates">
						<fieldset>
							<legend>v 1.6.4.1 от XX.XX.2017</legend>
							<div class="form-group">
								<ul>
									<li>Оптимизация настроек</li>
									<li>Оптимизация загрузки предложений</li>
								</ul>
							</div>
						</fieldset>
					</div><!-- tab-updates -->
...
function addConfigPriceType() {
	...
	<?php } ?>
	html += '</select></td>';
	html += '<td class="text-left"><select class="form-control" id="table_price" name="exchange1c_price_type[<?php echo $price_row; ?>][table_price]">';
	<?php foreach ($table_prices as $table_price) { ?>
		<?php $selected = '' ?>

		...
		<table id="module" style="background:#fcfcfc; border:solid 1px #ddd">
			...
			<tr>
	            ...
	            <td class="input-group">
					<input type="text" name="width" value="<?php echo $width; ?>" placeholder="<?php echo $entry_width; ?>" class="form-control" style="width:50px !important; text-align:center;" />
					<input type="text" name="height" value="<?php echo $height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" style="width:50px !important; text-align:center;" />
					<span>пикс.</span>

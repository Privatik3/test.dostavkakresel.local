...
function addImage() {
	...
	<?php if(VERSION >= 2.2) { ?>
	html += '<input type="text" name="gallery_image[' + image_row + '][gallery_image_description][<?php echo $language['language_id']; ?>][title]" value="" /> <img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /><br />';
	<?php } else { ?>

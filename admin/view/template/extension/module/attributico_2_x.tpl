            ...
            <div class="panel-body">
                ...
                <div id="tabs">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#tab-attribute" data-toggle="tab"><i class="fa fa-tree"></i> <?php echo $tab_attribute; ?> </a></li>
                        <li><a href="#tab-duty" data-toggle="tab"><i class="fa fa-database"></i> <?php echo $tab_duty; ?> </a></li>
                        <li><a href="#tab-category" data-toggle="tab"><i class="fa fa-list"></i> <?php echo $tab_category; ?></a> </li>
                        <li><a href="#tab-products" data-toggle="tab"><i class="fa fa-th"></i> <?php echo $tab_products; ?></a> </li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="tab-general">
                                <div class="col-xs-3">
                                    <ul class="nav nav-tabs tabs-left" id="verticalTab">
                                        <li><a href="#tab-common" data-toggle="tab"><?php echo $legend_general ?></a></li>
                                        <li><a href="#tab-children" data-toggle="tab"><?php echo $legend_children ?></a></li>
                                        <li><a href="#tab-ct" data-toggle="tab"><?php echo $legend_category ?></a></li>
                                        <li><a href="#tab-inherit" data-toggle="tab"><?php echo $legend_inherit ?></a></li>
                        ...
                        <div class="tab-pane active" id="tab-attribute">
                            <ul class="nav nav-tabs" id="tab-attribute_language">
                                <?php foreach ($languages as $language) { ?>
                                    <li><a href="#tab-attribute_language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="<?php echo $language['src']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                                <?php } ?>
                            </ul>
                            <div class="tab-content">
                                <?php foreach ($languages as $language) { ?>
                                    <div class="tab-pane" id="tab-attribute_language<?php echo $language['language_id']; ?>">
                                        <label class="checkbox-inline pull-right clearfix" for="tab-attribute_hideFilter<?php echo $language['language_id']; ?>">
                                            <input type="checkbox" class="hide" name="fs_tab-attribute_hideFilter<?php echo $language['language_id']; ?>" id="tab-attribute_hideFilter<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-attribute_hideFilter" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?> data-toggle="collapse" data-target="#tab-attribute_filter<?php echo $language['language_id']; ?>">
                                            <i class="fa fa-angle-double-down fa-lg" aria-hidden="true"></i>
                                        </label>
                                        <div class="form-group form-inline collapse <?php if (in_array("fs_tab-attribute_hideFilter" . $language['language_id'], $filter_settings)) { echo 'in'; } ?>" id="tab-attribute_filter<?php echo $language['language_id']; ?>">
                                            ...
                                            <label class="checkbox-inline" style="padding-top:0px;" for="tab-attribute_autoComplete<?php echo $language['language_id']; ?>">
                                                &nbsp;&nbsp;&nbsp;<input type="checkbox" name="fs_tab-attribute_autoComplete<?php echo $language['language_id']; ?>" id="tab-attribute_autoComplete<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-attribute_autoComplete" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_autoComplete[$language['language_id']]; ?>
                                            </label>
                                            <label class="checkbox-inline" style="padding-top:0px;" for="tab-attribute_attributesOnly<?php echo $language['language_id']; ?>">
                                                <input type="checkbox" name="fs_tab-attribute_attributesOnly<?php echo $language['language_id']; ?>" id="tab-attribute_attributesOnly<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-attribute_attributesOnly" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Attributes_only[$language['language_id']]; ?>
                                            </label>
                                            <label class="checkbox-inline" style="padding-top:0px;" for="tab-attribute_leavesOnly<?php echo $language['language_id']; ?>">
                                                <input type="checkbox" name="fs_tab-attribute_leavesOnly<?php echo $language['language_id']; ?>" id="tab-attribute_leavesOnly<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-attribute_leavesOnly" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Leaves_only[$language['language_id']]; ?>
                                            </label>
                                            ...
                                            <span  id="tab-attribute_searchmode<?php echo $language['language_id']; ?>">
                                                <label class="checkbox-inline" for="tab-attribute_hideMode<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-attribute_hideMode<?php echo $language['language_id']; ?>" id="tab-attribute_hideMode<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-attribute_hideMode" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Hide_unmatched_nodes[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-attribute_autoExpand<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-attribute_autoExpand<?php echo $language['language_id']; ?>" id="tab-attribute_autoExpand<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-attribute_autoExpand" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Auto_expand[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-attribute_counter<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-attribute_counter<?php echo $language['language_id']; ?>" id="tab-attribute_counter<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-attribute_counter" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Counter_badges[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-attribute_hideExpandedCounter<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-attribute_hideExpandedCounter<?php echo $language['language_id']; ?>" id="tab-attribute_hideExpandedCounter<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-attribute_hideExpandedCounter" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_hideExpandedCounter[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-attribute_highlight<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-attribute_highlight<?php echo $language['language_id']; ?>" id="tab-attribute_highlight<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-attribute_highlight" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Highlight[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-attribute_fuzzy<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-attribute_fuzzy<?php echo $language['language_id']; ?>" id="tab-attribute_fuzzy<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-attribute_fuzzy" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Fuzzy[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-attribute_regex<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-attribute_regex<?php echo $language['language_id']; ?>" id="tab-attribute_regex<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-attribute_regex" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Regular_expression[$language['language_id']]; ?>
                                                </label>
                                            </span>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div id="options_attribute_group_tree<?php echo $language['language_id']; ?>" title="<?php echo $text_Options[$language['language_id']]; ?>">
                                            ...
                                            <label class="checkbox-inline" for="sortOrder<?php echo $language['language_id']; ?>">
                                                <input type="checkbox" id="sortOrder_attribute_group_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_sortorder == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_sortOrder[$language['language_id']]; ?></b>
                                            </label>
                                        </div>
                                    </div>
                                <?php } ?>
                        ...
                        <div class="tab-pane" id="tab-duty">
                            <?php if ($duty_check) { ?>
                                ...
                                <?php foreach ($languages as $language) { ?>
                                    <li><a href="#tab-duty_language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="<?php echo $language['src']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                                <?php } ?>
                            </ul>
                            <div class="tab-content">
                                <?php foreach ($languages as $language) { ?>
                                    <div class="tab-pane" id="tab-duty_language<?php echo $language['language_id']; ?>">
                                        <label class="checkbox-inline pull-right clearfix" for="tab-duty_hideFilter<?php echo $language['language_id']; ?>">
                                            <input type="checkbox" class="hide" name="fs_tab-duty_hideFilter<?php echo $language['language_id']; ?>" id="tab-duty_hideFilter<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-duty_hideFilter" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?> data-toggle="collapse" data-target="#tab-duty_filter<?php echo $language['language_id']; ?>">
                                            <i class="fa fa-angle-double-down fa-lg" aria-hidden="true"></i>
                                        </label>
                                        <div class="form-group form-inline collapse <?php if (in_array("fs_tab-duty_hideFilter" . $language['language_id'], $filter_settings)) { echo 'in'; } ?>" id="tab-duty_filter<?php echo $language['language_id']; ?>">
                                            ...
                                            <label class="checkbox-inline" style="padding-top:0px;" for="tab-duty_autoComplete<?php echo $language['language_id']; ?>">
                                                &nbsp;&nbsp;&nbsp;<input type="checkbox" name="fs_tab-duty_autoComplete<?php echo $language['language_id']; ?>" id="tab-duty_autoComplete<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-duty_autoComplete" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_autoComplete[$language['language_id']]; ?>
                                            </label>
                                            <label class="checkbox-inline" style="padding-top:0px;" for="tab-duty_attributesOnly<?php echo $language['language_id']; ?>">
                                                <input type="checkbox" name="fs_tab-duty_attributesOnly<?php echo $language['language_id']; ?>" id="tab-duty_attributesOnly<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-duty_attributesOnly" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Attributes_only[$language['language_id']]; ?>
                                            </label>
                                            <label class="checkbox-inline" style="padding-top:0px;" for="tab-duty_leavesOnly<?php echo $language['language_id']; ?>">
                                                <input type="checkbox" name="fs_tab-duty_leavesOnly<?php echo $language['language_id']; ?>" id="tab-duty_leavesOnly<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-duty_leavesOnly" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Leaves_only[$language['language_id']]; ?>
                                            </label>
                                            <div class="ajax-loader"><img id="loadImg<?php echo $language['language_id']; ?>" src="view/javascript/fancytree/skin-win7/loading.gif" style="z-index:1000; display:none;"/></div>
                                            <span  id="tab-duty_searchmode<?php echo $language['language_id']; ?>">
                                                <label class="checkbox-inline" for="tab-duty_hideMode<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-duty_hideMode<?php echo $language['language_id']; ?>" id="tab-duty_hideMode<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-duty_hideMode" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Hide_unmatched_nodes[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-duty_autoExpand<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-duty_autoExpand<?php echo $language['language_id']; ?>" id="tab-duty_autoExpand<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-duty_autoExpand" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Auto_expand[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-duty_counter<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-duty_counter<?php echo $language['language_id']; ?>" id="tab-duty_counter<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-duty_counter" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Counter_badges[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-duty_hideExpandedCounter<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-duty_hideExpandedCounter<?php echo $language['language_id']; ?>" id="tab-duty_hideExpandedCounter<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-duty_hideExpandedCounter" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_hideExpandedCounter[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-duty_highlight<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-duty_highlight<?php echo $language['language_id']; ?>" id="tab-duty_highlight<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-duty_highlight" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Highlight[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-duty_fuzzy<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-duty_fuzzy<?php echo $language['language_id']; ?>" id="tab-duty_fuzzy<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-duty_fuzzy" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Fuzzy[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-duty_regex<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-duty_regex<?php echo $language['language_id']; ?>" id="tab-duty_regex<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-duty_regex" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Regular_expression[$language['language_id']]; ?>
                                                </label>
                                            </span>
                                        </div>
                                            <div class="form-group">
                                            ...
                                            <div id="options_duty_attribute_tree<?php echo $language['language_id']; ?>" title="<?php echo $text_Options[$language['language_id']]; ?>">
                                                ...
                                                <br>
                                                <label class="checkbox-inline" for="sortOrder<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" id="sortOrder_duty_attribute_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_sortorder == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_sortOrder[$language['language_id']]; ?></b>
                                                </label>
                                            </div>
                                        </div>
                                    <?php } ?>
                        ...
                        <div class="tab-pane" id="tab-category">
                            <ul class="nav nav-tabs" id="tab-category_language">
                                <?php foreach ($languages as $language) { ?>
                                    <li><a href="#tab-category_language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="<?php echo $language['src']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                                <?php } ?>
                            </ul>
                            <div class="tab-content">
                                <?php foreach ($languages as $language) { ?>
                                    <div class="tab-pane" id="tab-category_language<?php echo $language['language_id']; ?>">
                                        <label class="checkbox-inline pull-right clearfix" for="tab-category_hideFilter<?php echo $language['language_id']; ?>">
                                            <input type="checkbox" class="hide" name="fs_tab-category_hideFilter<?php echo $language['language_id']; ?>" id="tab-category_hideFilter<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-category_hideFilter" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?> data-toggle="collapse" data-target="#tab-category_filter<?php echo $language['language_id']; ?>">
                                            <i class="fa fa-angle-double-down fa-lg" aria-hidden="true"></i>
                                        </label>
                                        <div class="form-group form-inline collapse <?php if (in_array("fs_tab-category_hideFilter" . $language['language_id'], $filter_settings)) { echo 'in'; } ?>" id="tab-category_filter<?php echo $language['language_id']; ?>">
                                            ...
                                            <label class="checkbox-inline" style="padding-top:0px;" for="tab-category_autoComplete<?php echo $language['language_id']; ?>">
                                                &nbsp;&nbsp;&nbsp;<input type="checkbox" name="fs_tab-category_autoComplete<?php echo $language['language_id']; ?>" id="tab-category_autoComplete<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-category_autoComplete" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_autoComplete[$language['language_id']]; ?>
                                            </label>
                                            <label class="checkbox-inline" style="padding-top:0px;" for="tab-category_attributesOnly<?php echo $language['language_id']; ?>">
                                                <input type="checkbox" name="fs_tab-category_attributesOnly<?php echo $language['language_id']; ?>" id="tab-category_attributesOnly<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-category_attributesOnly" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Attributes_only[$language['language_id']]; ?>
                                            </label>
                                            <label class="checkbox-inline" style="padding-top:0px;" for="tab-category_leavesOnly<?php echo $language['language_id']; ?>">
                                                <input type="checkbox" name="fs_tab-category_leavesOnly<?php echo $language['language_id']; ?>" id="tab-category_leavesOnly<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-category_leavesOnly" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Leaves_only[$language['language_id']]; ?>
                                            </label>
                                            <div class="ajax-loader"><img id="loadImg<?php echo $language['language_id']; ?>" src="view/javascript/fancytree/skin-win7/loading.gif" style="z-index:1000; display:none;"/></div>
                                            <span  id="tab-category_searchmode<?php echo $language['language_id']; ?>">
                                                <label class="checkbox-inline" for="tab-category_hideMode<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-category_hideMode<?php echo $language['language_id']; ?>" id="tab-category_hideMode<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-category_hideMode" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Hide_unmatched_nodes[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-category_autoExpand<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-category_autoExpand<?php echo $language['language_id']; ?>" id="tab-category_autoExpand<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-category_autoExpand" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Auto_expand[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-category_counter<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-category_counter<?php echo $language['language_id']; ?>" id="tab-category_counter<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-category_counter" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Counter_badges[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-category_hideExpandedCounter<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-category_hideExpandedCounter<?php echo $language['language_id']; ?>" id="tab-category_hideExpandedCounter<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-category_hideExpandedCounter" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_hideExpandedCounter[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-category_highlight<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-category_highlight<?php echo $language['language_id']; ?>" id="tab-category_highlight<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-category_highlight" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Highlight[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-category_fuzzy<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-category_fuzzy<?php echo $language['language_id']; ?>" id="tab-category_fuzzy<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-category_fuzzy" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Fuzzy[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-category_regex<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-category_regex<?php echo $language['language_id']; ?>" id="tab-category_regex<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-category_regex" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Regular_expression[$language['language_id']]; ?>
                                                </label>
                                            </span>
                                        </div>
                                                    ...
                                                    <tr>
                                                        <td class="left" style="width: 50%;">
                                                            ...
                                                            <div id="options_category_tree<?php echo $language['language_id']; ?>" title="<?php echo $text_Options[$language['language_id']]; ?>">
                                                                ...
                                                                <br>
                                                                <label class="checkbox-inline" for="sortOrder<?php echo $language['language_id']; ?>">
                                                                    <input type="checkbox" id="sortOrder_category_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_sortorder == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_sortOrder[$language['language_id']]; ?></b>
                                                                </label>
                                                                <br>
                                                                <label class="checkbox-inline" for="multiSelect<?php echo $language['language_id']; ?>">
                                                                    <input type="checkbox" id="multiSelect_category_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_multiselect == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_multiSelect[$language['language_id']]; ?></b>
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td class="left">
                                                            ...
                                                            <div id="options_category_attribute_tree<?php echo $language['language_id']; ?>" title="<?php echo $text_Options[$language['language_id']]; ?>">
                                                                ...
                                                                <br>
                                                                <label class="checkbox-inline" for="sortOrder<?php echo $language['language_id']; ?>">
                                                                    <input type="checkbox" id="sortOrder_category_attribute_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_sortorder == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_sortOrder[$language['language_id']]; ?></b>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="left" style="width: 50%;">
                                                            ...
                                                            <div id="options_attribute_tree<?php echo $language['language_id']; ?>" title="<?php echo $text_Options[$language['language_id']]; ?>">
                                                                ...
                                                                <br>
                                                                <label class="checkbox-inline" for="sortOrder<?php echo $language['language_id']; ?>">
                                                                    <input type="checkbox" id="sortOrder_attribute_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_sortorder == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_sortOrder[$language['language_id']]; ?></b>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                        ...
                        <div class="tab-pane" id="tab-products">
                            <ul class="nav nav-tabs" id="tab-products_language">
                                <?php foreach ($languages as $language) { ?>
                                    <li><a href="#tab-products_language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="<?php echo $language['src']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                                <?php } ?>
                            </ul>
                            <div class="tab-content">
                                <?php foreach ($languages as $language) { ?>
                                    <div class="tab-pane" id="tab-products_language<?php echo $language['language_id']; ?>">
                                        <label class="checkbox-inline pull-right clearfix" for="tab-products_hideFilter<?php echo $language['language_id']; ?>">
                                            <input type="checkbox" class="hide" name="fs_tab-products_hideFilter<?php echo $language['language_id']; ?>" id="tab-products_hideFilter<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-products_hideFilter" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?> data-toggle="collapse" data-target="#tab-products_filter<?php echo $language['language_id']; ?>">
                                            <i class="fa fa-angle-double-down fa-lg" aria-hidden="true"></i>
                                        </label>
                                        <div class="form-group form-inline collapse <?php if (in_array("fs_tab-products_hideFilter" . $language['language_id'], $filter_settings)) { echo 'in'; } ?>" id="tab-products_filter<?php echo $language['language_id']; ?>">
                                            ...
                                            <label class="checkbox-inline" style="padding-top:0px;" for="tab-products_autoComplete<?php echo $language['language_id']; ?>">
                                                &nbsp;&nbsp;&nbsp;<input type="checkbox" name="fs_tab-products_autoComplete<?php echo $language['language_id']; ?>" id="tab-products_autoComplete<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-products_autoComplete" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_autoComplete[$language['language_id']]; ?>
                                            </label>
                                            <label class="checkbox-inline" style="padding-top:0px;" for="tab-products_attributesOnly<?php echo $language['language_id']; ?>">
                                                <input type="checkbox" name="fs_tab-products_attributesOnly<?php echo $language['language_id']; ?>" id="tab-products_attributesOnly<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-products_attributesOnly" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Attributes_only[$language['language_id']]; ?>
                                            </label>
                                            <label class="checkbox-inline" style="padding-top:0px;" for="tab-products_leavesOnly<?php echo $language['language_id']; ?>">
                                                <input type="checkbox" name="fs_tab-products_leavesOnly<?php echo $language['language_id']; ?>" id="tab-products_leavesOnly<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-products_leavesOnly" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Leaves_only[$language['language_id']]; ?>
                                            </label>
                                            <div class="ajax-loader"><img id="loadImg<?php echo $language['language_id']; ?>" src="view/javascript/fancytree/skin-win7/loading.gif" style="z-index:1000; display:none;"/></div>
                                            <span  id="tab-products_searchmode<?php echo $language['language_id']; ?>">
                                                <label class="checkbox-inline" for="tab-products_hideMode<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-products_hideMode<?php echo $language['language_id']; ?>" id="tab-products_hideMode<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-products_hideMode" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Hide_unmatched_nodes[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-products_autoExpand<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-products_autoExpand<?php echo $language['language_id']; ?>" id="tab-products_autoExpand<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-products_autoExpand" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Auto_expand[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-products_counter<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-products_counter<?php echo $language['language_id']; ?>" id="tab-products_counter<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-products_counter" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Counter_badges[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-products_hideExpandedCounter<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-products_hideExpandedCounter<?php echo $language['language_id']; ?>" id="tab-products_hideExpandedCounter<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-products_hideExpandedCounter" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_hideExpandedCounter[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-products_highlight<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-products_highlight<?php echo $language['language_id']; ?>" id="tab-products_highlight<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-products_highlight" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Highlight[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-products_fuzzy<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-products_fuzzy<?php echo $language['language_id']; ?>" id="tab-products_fuzzy<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-products_fuzzy" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Fuzzy[$language['language_id']]; ?>
                                                </label>
                                                <label class="checkbox-inline" for="tab-products_regex<?php echo $language['language_id']; ?>">
                                                    <input type="checkbox" name="fs_tab-products_regex<?php echo $language['language_id']; ?>" id="tab-products_regex<?php echo $language['language_id']; ?>" <?php if (in_array("fs_tab-products_regex" . $language['language_id'], $filter_settings)) { echo 'checked'; } ?>> <?php echo $text_Regular_expression[$language['language_id']]; ?>
                                                </label>
                                            </span>
                                        </div>
                                        <div class="table-responsive">
                                                    ...
                                                    <tr>
                                                        <td class="left" style="width: 50%;">
                                                            ...
                                                            <div id="options_attribute_product_tree<?php echo $language['language_id']; ?>" title="<?php echo $text_Options[$language['language_id']]; ?>">
                                                               ...
                                                               <br>
                                                               <label class="checkbox-inline" for="sortOrder<?php echo $language['language_id']; ?>">
                                                                   <input type="checkbox" id="sortOrder_attribute_product_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_sortorder == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_sortOrder[$language['language_id']]; ?></b>
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td class="left">
                                                            ...
                                                            <div id="options_product_tree<?php echo $language['language_id']; ?>" title="<?php echo $text_Options[$language['language_id']]; ?>">
                                                                ...
                                                                <br>
                                                                <label class="checkbox-inline" for="sortOrder<?php echo $language['language_id']; ?>">
                                                                    <input type="checkbox" id="sortOrder_product_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_sortorder == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_sortOrder[$language['language_id']]; ?></b>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    </tr>
				...
				<div class="col-lg-10 col-md-9" style="border-left: 1px solid #eee;" id="column-2">
						...
						<table class="table table-bordered">
						  ...
						  <tbody>
							<tr>
							  <th style="text-align: center;"> <?php echo $help_nosettings; ?> </th>
							  <td><button type="button" onclick=" return tools('empty')" data-toggle="tooltip" title="<?php echo $button_play; ?>" class="btn btn-warning"><i class="fa fa-play"></i></button></td>
                                                          <td><div class="ajax-loader"><img class= "loader-img" src="view/javascript/fancytree/skin-win7/loading.gif" style="display:none;"/></div>
                                                              <div class="ajax-loader"><img class= "complete-img" src="view/javascript/fancytree/skin-custom/accept.png" style="display:none;"/></div>
                                                           </td>
                                                        </tr>
						  </tbody>
						</table>
...
<script type="text/javascript"><!--
    var selNodes = null, selCategories=null;
    var $attribute_trees = $('[name ^= "attribute_group_tree"], [name ^= "attribute_tree"], [name ^= "duty_attribute_tree"], [name ^= "attribute_product_tree"]');
    ...
    var currentCategory = 0, currentAttributeID = 0;

    $attribute_group_tree.each(function (indx, element) {
        var lng_id = parseInt(element.id.replace(/\D+/ig, ''));
        contextmenu[lng_id] = [
            {title: <?php echo json_encode($text_Edit) ?>[lng_id] + "<kbd>[Shift+Click]</kbd>", cmd: "rename", uiIcon: "ui-icon-pencil"},
            {title: <?php echo json_encode($text_Delete) ?>[lng_id] + "<kbd>[Del]</kbd>", cmd: "remove", uiIcon: "ui-icon-trash"},
            {title: <?php echo json_encode($text_Copy) ?>[lng_id] + "<kbd>Ctrl+C</kbd>", cmd: "copy", uiIcon: "ui-icon-copy", disabled: true},
            {title: <?php echo json_encode($text_Paste) ?>[lng_id] + "<kbd>Ctrl+V</kbd>", cmd: "paste", uiIcon: "ui-icon-clipboard", disabled: true},
            {title: "----"},
            {title: <?php echo json_encode($text_Expande) ?>[lng_id] + "<kbd>Ctrl+B</kbd>", cmd: "expande", uiIcon: "ui-icon-folder-open"},
            {title: <?php echo json_encode($text_Collapse) ?>[lng_id] + "<kbd>Ctrl+B</kbd>", cmd: "collapse", uiIcon: "ui-icon-folder-collapsed"},
            {title: <?php echo json_encode($text_Options) ?>[lng_id], cmd: "options", uiIcon: "ui-icon-gear"},
            {title: "----"},
            {title: <?php echo json_encode($text_New_group) ?>[lng_id] + "<kbd>[Ctrl+M]</kbd>", cmd: "addSibling", uiIcon: "ui-icon-plus"},
            {title: <?php echo json_encode($text_New_attribute) ?>[lng_id] + "<kbd>[Ctrl+Q]</kbd>", cmd: "addChild", uiIcon: "ui-icon-arrowreturn-1-e"}
        ];
    });
    ...
    $(document).ready(function () {
        ...
        $('input[id ^= "sortOrder"]:checkbox').change(function (e) {
            var id = $(this).attr("id"), tree = $("#" + id.replace("sortOrder_", "")).fancytree("getTree"),
        ...
        $('input[id ^= "multiSelect"]:checkbox').change(function (e) {
            var id = $(this).attr("id"), tree = $("#" + id.replace("multiSelect_", "")).fancytree("getTree");
        ...
        if ($('input[name = "attributico_smart_scroll"]:checkbox').is(":checked")) {

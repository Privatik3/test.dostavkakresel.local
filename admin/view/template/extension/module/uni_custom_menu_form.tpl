  ...
  <div class="container-fluid">
    ...
    <table class="form">
		...
		<?php foreach ($languages as $language) { ?>
			...
			<input type="text" name="menu_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($menu_description[$language['language_id']]) ? $menu_description[$language['language_id']]['name'] : ''; ?>" class="form-control" />
			</div>
		...
		<?php if($uni_custom_menu) { 
			foreach($uni_custom_menu as $menu) {

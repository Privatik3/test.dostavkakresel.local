  ...
  <tfoot>
   <tr>
    <td class="center">
     ...
     <a class="btn btn-success" onclick="editLink('ocfilter', 'update', <?php echo $product_id; ?>);"><?php echo $button_save; ?></a>
...
$(document).ready(function() {
	$('#dialogLink').modal({'title':'<?php echo $text_ocfilter; ?>'});
});
//--></script>
<?php } else { ?>
<form id="form-ocfilter<?php echo $product_id; ?>">
 ...
 <table class="be-list">
  <tfoot>
   <tr>
    ...
    <td class="center">
     <a class="btn btn-primary" onclick="editLink('ocfilter', 'insert', <?php echo $product_id; ?>);"><?php echo $button_insert_sel; ?></a>
     <a class="btn btn-primary" onclick="editLink('ocfilter', 'delete', <?php echo $product_id; ?>);"><?php echo $button_delete_sel; ?></a>
     <a class="btn btn-primary" onclick="editLink('ocfilter', 'update', <?php echo $product_id; ?>);"><?php echo $text_edit; ?></a>
    </td>
   </tr>
  </tfoot>
 </table>

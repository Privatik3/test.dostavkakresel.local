			...
			<?php foreach ($categories as $category) { ?>
				<div class="product-layout-1">
					<div class="categorywall_thumbnail product-thumb">
						...
						<?php } ?>
						<!--noindex--><div class="image"><a rel="nofollow" href="<?php echo $category['href']; ?>"><img class="img-responsive" src="<?php echo $category['image']; ?>" alt="<?php echo $category['name']; ?>"></a></div><!--/noindex-->
				...
				<div class="product-layout-1">
					<div class="product-thumb transition">
						<div class="categorywall_thumbnail <?php if ($category['children']) echo ' half'; ?>">
							...
							<!--noindex--><a rel="nofollow" href="<?php echo $category['href']; ?>"><img class="img-responsive" src="<?php echo $category['image']; ?>" alt="<?php echo $category['name']; ?>"></a><!--/noindex-->
							<?php if ($category['children']) { ?>
								<div class="children">
									<ul>
										<?php foreach ($category['children'] as $child) { ?>

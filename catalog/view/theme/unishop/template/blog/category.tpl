...
<div class="container">
	...
	<div class="row"><?php echo $column_left; ?>
		...
		<div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
			...
			<?php if ($thumb || ($description && $description != '<p><br></p>')) { ?>
			...
			<?php if ($categories) { ?>
				<div class="row">
					<?php foreach ($categories as $category) { ?>
						<div class="category_list col-lg-4">
							<a href="<?php echo $category['href']; ?>">
								<?php if(isset($category['thumb'])) { ?><img src="<?php echo $category['thumb']; ?>" alt="<?php echo $category['name']; ?>" title="" class="img-responsive" /><?php } ?>

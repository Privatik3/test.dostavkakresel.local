<?php echo $header; ?>
<div class="container">
	<ul class="breadcrumb <?php if (in_array('product/special', $menu_schema)) { ?>col-md-offset-4 col-lg-offset-3<?php } ?>">
	...
	<div class="row"><?php echo $column_left; ?>
		...
		<?php } else { ?>
			<?php $class = 'col-sm-12'; ?>
		<?php } ?>
		<?php if (in_array('product/special', $menu_schema) && !$column_left && $column_right) { $class = 'col-sm-8 col-md-8 col-lg-6 col-md-offset-4 col-lg-offset-3'; } ?>
		<?php if (in_array('product/special', $menu_schema) && !$column_left && !$column_right) { $class = 'col-sm-8 col-md-8 col-lg-9 col-md-offset-4 col-lg-offset-3'; } ?>
					...
					<?php foreach ($products as $product) { ?>
						<div class="product-layout product-grid <?php echo $class; ?>">
							<div class="product-thumb transition">
								...
								<div class="cart">
									<button type="button" class="add_to_cart button btn btn-default <?php echo $product['cart_btn_class']; ?> <?php echo $product['product_id']; ?>" data-toggle="tooltip" title="<?php echo $product['cart_btn_text']; ?>" onclick="cart.add(<?php echo $product['product_id']; ?>)">
										<i class="<?php echo $product['cart_btn_icon']; ?>"></i>
										<span class="hidden-sm"><?php echo $product['cart_btn_text']; ?></span>
									</button>

      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td style="text-center">
			<button type="button" class="add_to_cart button btn btn-default <?php echo $product['cart_btn_class']; ?>" data-toggle="tooltip" title="<?php echo $product['cart_btn_text']; ?>" onclick="cart.add(<?php echo $product['product_id']; ?>)"><i class="<?php echo $product['cart_btn_icon']; ?>"></i> <span class="hidden-sm"><?php echo $product['cart_btn_text']; ?></span></button>
			<br /><br />

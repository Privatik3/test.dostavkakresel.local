<?php echo $header; ?>
<div class="container">
	<ul class="breadcrumb <?php if (in_array('product/manufacturer/info', $menu_schema)) { ?>col-md-offset-4 col-lg-offset-3<?php } ?>">
	...
	<div class="row"><?php echo $column_left; ?>
		...
		<?php } else { ?>
			<?php $class = 'col-sm-12'; ?>
		<?php } ?>
		<?php if (in_array('product/manufacturer/info', $menu_schema) && !$column_left && $column_right) { $class = 'col-sm-8 col-md-8 col-lg-6 col-md-offset-4 col-lg-offset-3'; } ?>
		<?php if (in_array('product/manufacturer/info', $menu_schema) && !$column_left && !$column_right) { $class = 'col-sm-8 col-md-8 col-lg-9 col-md-offset-4 col-lg-offset-3'; } ?>
		<div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
			...
			<?php if(isset($thumb) || isset($description))  { ?>
				<div class="manufacturer_block row">
					...
					<?php } ?>
					<div class="<?php if($thumb)  { ?>col-xs-12 col-sm-10<?php } else { ?>col-xs-12<?php } ?>">
